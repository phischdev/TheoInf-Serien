...
\title{
	...
	\begin{enumerate}[(a)]
		...
		\item
		Zuerst weisen wir den Bussen eine Reihenfolge zu, je nach dem, wann sie angekommen sind. Der erste Bus, der ankommt, bekommt Nummer 1, usw. Wir beschreiben wieder den j-ten Gast aus Bus i mit dem Tupel $(i,j)$, mit $i \in \{1,2,3\},\ j \in \mathbb{N}$. Dann weisen wir dem Gast $(i,j)$ die Zimmernummer $p_i^j$ zu, wobei $p$ die $i$-te Primzahl ist (nach Grösse geordnet). So hat jeder Gast eindeutig ein Zimmer, weil jede gegebene Primzahl und ihre Potenzen teilerfremd zu jeder anderen Primzahl und ihren Potenzen ist (für positive Exponenten) und weil es abzählbar unendlich viele Primzahlen gibt.
