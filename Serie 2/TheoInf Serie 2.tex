...
Bemerkung: In dieser Aufgabe verwenden wir im Pascal Code den Exponentiation Operator \^{}, der nicht in der ursprünglichen Syntax enthalten ist. Der Code wird damit aber lesbarer und die Kolmogorov Komplexität ist unabhängig davon, ob man Loops oder den Operator \^{} für die Exponentiation verwendet.
