...
\title{
	...
	Sei $A = [d_{ij}]_{i,j=1,...,\infty}$ eine unendliche Boole’sche Matrix mit	$d_{ij} = 1 \iff M_i$ akzeptiert $w_j$.
	
	Dann ist für $L_1$ $d_{i,i^2}=0$ und für $L_2$ $d_{i^2,i}=0$, ansonsten 1.
