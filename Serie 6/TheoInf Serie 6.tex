...
\title{
	...
	\begin{enumerate}[(a)]
		...
		\end{itemize}
		Damit wiederholt sich das Muster $(1,j)$, $(2,j)$, $(2,j)$, $(3,j)$ für aufsteigende Zimmernummern. Damit sind Gäste aus Bus 1 in ungeraden Zimmernummern und Gäste aus Bus 2 immer paarweise nebeneinander.
