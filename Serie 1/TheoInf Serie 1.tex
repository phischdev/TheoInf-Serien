...
\begin{enumerate}[(a)]
	\item
	Insgesamt gibt es $3^n$ verschiedene Wörter der Länge n.\\
	...
	Bei Länge $i$ lassen sich Teilwörter an den Stellen $\{1,\,2,\,...,\,m-i+1\}$ mit Länge $i$ nehmen.\\
	Es gibt also höchstens
	\begin{equation}
		\sum^m_{i=1}m-i+1 = \sum^m_{i=1}k
	\end{equation}
...
\begin{enumerate}[(a)]
	\item
	\begin{align}
		L_2\cdot (L_2-L_1) &= \{xy | x\in L_2 \wedge y\in L_2-L_1\}\\
		&= \{xy | x\in L_2 \wedge y\in L_2 \wedge y \not\in L_1\}\\
		&= \{xy | (x\in L_2 \wedge y\in L_2) \wedge (x\in L_2 \wedge y \not\in L_1)\}\\
		&=\{xy|x\in L_2 \wedge y \in L_2\} - \{xy|x\in L_2 \wedge y \in L_1\}\\
		&=(L_2)^2 - L_2\cdot L_1
	\end{align} 
	\item
	z.Z $(\{a\}^*\{b\}^*)^* \neq (\{a,\,b\}^2)^*$\\
...
\begin{homeworkProblem} 
 ...
 \begin{itemize} 
 	...
 	\begin{itemize} 
 		...
 		Beweis: $\Sigma = \{a,b\} \Rightarrow \Sigma ^* = \{a,b\}^* \eq \bigcup_{i\in\mathbb{N}}\{a,b\}^i = (\bigcup_{i\in\mathbb{N}\text{, i gerade}} \{a,b\}^i) \cup (\bigcup_{i\in\mathbb{N}\text{, i ungerade}} \{a,b\}^i) \Rightarrow \bigcup_{i\in\mathbb{N}\text{, i gerade}} \{a,b\}^i \subseteq \Sigma^*$ 
 
 
 		\item 
 		\begin{itemize} 
 			Zu zeigen: $L \subseteq \bigcup_{i\in\mathbb{N}\text{, i gerade}}\{a,b\}^i$ \\ 
 			Beweis: $\bigcup_{i\in\mathbb{N}\text{, i gerade}}\{a,b\}^i = \bigcup_{k\in\mathbb{N}} \{a,b\}^{2k} = \bigcup_{k\in\mathbb{N}} (\{a,b\}^2)^{k} = \bigcup_{k\in\mathbb{N}} \{aa,ab,ba,bb\}^{k}$ \\ 
 			$\bigcup_{k\in\mathbb{N}} \{a,b\}^{k} \subseteq \bigcup_{k\in\mathbb{N}} \{aa,ab,ba,bb\}^{k} \Rightarrow $  
 		\end{itemize} 
