...
\begin{homeworkProblem}
	\begin{enumerate}[(a)]
		...
		Seien $L_1, L_2 \in \NTIME(f)$, dann gibt es nichtdeterministische MTMs $M_1, M_2$ mit $L(M_1)=L_1$ und $L(M_2)=L_2$ und $\Time_{M_1}, \Time_{M_2} \in \mathcal{O}(f(n))$.\\
		...
		Um zu akzeptieren braucht $M$ das Minimum der Zeit der beiden MTMs um zu akzeptieren. Daher ist $\Time_M(x) \in \mathcal{O}(x)$. Daher folgt, dass $L=L(M) \in \NTIME(f)$.
